...
curl -H "Content-Type: application/txt" -XPOST 'localhost:9200/task1a/wikipage/_bulk?pretty&refresh' --data-binary "@data/out.txt"
...
curl -H "Content-Type: application/txt" -XPOST 'localhost:9200/task1b/wikipage/_bulk?pretty&refresh' --data-binary "@data/out.txt"
